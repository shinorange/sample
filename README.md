...
3. **900〜1150℃(橙〜黄熱)で打つと「会心の一打」**になり、剣の出来栄えが上がります(火花も増える)
4. 冷えたら炉で熱し直す(打つたびに約12℃、置いておくだけでも冷めます)
5. 海綿鉄→鋼片→鋼材→**荒打ちの刀身**と打ち進める
...
> **鍛造鋼の剣**: 攻撃速度1.8・耐久780・エンチャント性14。刀身1本を消費して金床修理も可能。
> **攻撃力はあなたの腕前で6.6〜8.5に変化します**(下記参照)。

## 剣の出来(クオリティ)

剣の攻撃力は固定ではなく、製作の丁寧さで決まります。

- **鍛えの質(65%)** — 金床での全打撃のうち、**900〜1150℃の「会心の一打」**だった割合
- **焼き入れの質(35%)** — 焼き入れ温度が理想の**865℃**にどれだけ近かったか
...
工程中も刀身のツールチップに「鍛えの質」「焼き入れの質」が表示されるので、腕の上達が見えます。割れた刀身を打ち直しても履歴は引き継がれます(挽回可能)。
