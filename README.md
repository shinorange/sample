...
1. 鍛冶炉に**木炭または石炭**を右クリックでくべる(1個=60秒、最大300秒)
2. **火打石と打ち金**で点火
3. **手ふいご**で右クリック連打して送風。基本900℃ → 送風最大で約1280℃まで上昇
4. 素手で右クリックすると「炉温/燃料/送風」が確認できます

### 2. 製錬(せいれん)

**原鉄(raw iron)** を持って炉を右クリックして投入。**1150℃以上を30秒**保つと「海綿鉄の塊」に。送風を絶やさないこと。
...
焼き入れした刀身を炉に入れ、**150〜400℃を20秒**保つと「焼き戻しした刀身」に。
**460℃を超えると硬さが失われて荒打ちに逆戻り**。火力を上げすぎないこと(燃料切れ間際の弱い火が最適)。
